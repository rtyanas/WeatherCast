...
// 
public class DisplayWeatherInfoQuadGraphicsActivity extends FragmentActivity {
...
//	}
	 ...
	 *
	 */
	public class AssembleWeatherAsync extends AsyncTask<DisplayWeatherInfoQuadGraphicsActivity, 
	                                                   Integer, WeatherDataParsed> {
	    
        private ProgressDialog progressD;
        
	    public AssembleWeatherAsync() {
	        progressD = new ProgressDialog(DisplayWeatherInfoQuadGraphicsActivity.this);	        
	    }
	    
	    protected void onPreExecute() {
	        this.progressD.setTitle("Retrieving weather");
            this.progressD.setMessage(
                    (DisplayWeatherInfoQuadGraphicsActivity.this.location.split(",").length > 1 ? 
	    ...
	    protected WeatherDataParsed doInBackground(DisplayWeatherInfoQuadGraphicsActivity... displayW )
	    {
	        AssembleWeatherData assembleWeatherData = new AssembleWeatherData(
	                DisplayWeatherInfoQuadGraphicsActivity.this.location);
	    ...
	    protected void onPostExecute(WeatherDataParsed wdp_in)
	    {
	        ...
	        DisplayWeatherInfoQuadGraphicsActivity.this.ddL = wdp_in.generateDisplayDataList();   
	        stringSize = ddL.size();
	        
	        // Display the data onPostExecute
	        DisplayWeatherInfoQuadGraphicsActivity.this.mPagerAdapter.notifyDataSetChanged();
	    }
